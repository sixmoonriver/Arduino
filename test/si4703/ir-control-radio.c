...
OneButton menuButton(A0, true);
OneButton seekButton(A1, true);
...
// 频道减
else if (results.value ==  1886439479)
{
    if (i_sidx > 0) {
      i_sidx--;
      radio.setFrequency(preset[i_sidx]);
...
// increase volume
else if (results.value ==  1886398679)
{
    int v = radio.getVolume();
    if (v < 15) radio.setVolume(++v);	
}    
// decrease volume
else if (results.value ==  1886431319)
{
    int v = radio.getVolume();
    if (v > 0) radio.setVolume(--v);	
}
// 静音
else if (results.value ==  1886433359)
{
    radio.setMute(! radio.getMute());	
}
// 切换到预存频道0
else if (results.value ==  1886421119)
{
	radio.setFrequency(preset[0]);	
}
// 切换到预存频道1
else if (results.value ==  1886404799)
{
	radio.setFrequency(preset[1]);	
}
// 切换到预存频道2
else if (results.value ==  1886437439)
{
	radio.setFrequency(preset[2]);	
}
// 切换到预存频道3
else if (results.value ==  1886396639)
{
	radio.setFrequency(preset[3]);	
}
// 切换到预存频道4
else if (results.value ==  1886429279)
{
	radio.setFrequency(preset[4]);	
}
// 切换到预存频道5
else if (results.value ==  1886412959)
{
	radio.setFrequency(preset[5]);	
}
// 切换到预存频道6
else if (results.value ==  1886445599)
{
	radio.setFrequency(preset[6]);	
}
// 切换到预存频道7
else if (results.value ==  1886392559)
{
	radio.setFrequency(preset[7]);
}
// 切换到预存频道8
else if (results.value ==  1886425199)
{
	radio.setFrequency(preset[8]);	
}
// 切换到预存频道9
else if (results.value ==  1886388479)
{
	radio.setFrequency(preset[9]);	
}*/
irrecv.resume();
 // 接收下一个编码
}
